...
**CCOM resource:** `contacts`

## SPCX summary

Customer/end-user record.

## Connect PHP status

Core object. Expected Connect PHP class: `RNCPHP\Contact`; expand with version-checked fields and examples.
...
See [`examples/contacts/`](../examples/contacts/) for original SPCX examples.
